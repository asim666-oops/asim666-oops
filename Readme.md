...
| **[SOC wazuh SIEM Thread Dection (Wazuh)](https://github.com/asim666-oops/wazuh-SIEM-Threat-Detection)**    | SWazuh SIEM lab demonstrating detection and analysis of Mimikatz, brute force attacks, and file tampering using Sysmon, with MITRE ATT&CK mapping and log correlation. Highlights security gaps, system hardening, and the importance of analyst-driven investigation in SOC operations. | 
