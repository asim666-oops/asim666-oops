...
<div>
<img src="https://img.shields.io/badge/CICSA-Certified-000000?style=for-the-badge&logoColor=white" alt="CICSA Certification" />
<img src="https://img.shields.io/badge/CSA%20EC--Council-Certified-000000?style=for-the-badge&logoColor=white" alt="CSA EC-Council Certification" />
...
| **Project**      | **Description**                                                                                  |
|-------------------|--------------------------------------------------------------------------------------------------|
| **[SOC Investigation Threat Detection Lab](https://github.com/asim666-oops/SOC-Investigation-Threat-Detection-Lab)**    | This project demonstrates simulated enterprise SOC investigations performed using Splunk and Elastic Stack SIEM platforms. Multiple attack scenarios were analyzed to practice alert triage, threat hunting, IOC extraction, MITRE ATT&CK technique mapping, and structured incident documentation, enabling deeper understanding of attacker behavior and defensive detection strategies. |
| **[Phishing Email detection IOC Analysis](https://github.com/asim666-oops/Phishing_Email_detection_-_IOC_Analysis)**    | This repository showcases a real-world SOC phishing email investigation workflow, including email header analysis, SPF/DKIM/DMARC validation, URL and redirect analysis, attachment hash reputation checks, and IOC extraction. All analysis was performed using passive techniques and documented in SOC-ready Markdown format, aligned with MITRE ATT&CK. |
| **[SOC Home Lab Environment (Splunk)](https://github.com/asim666-oops/SOC-Threat-Detection-Alert-Triage-Lab)**    | SOC home lab demonstrating real-world threat detection, alert triage, investigation, and incident escalation using Splunk SIEM. Includes Kali attack simulations, Windows Event Log analysis , SPL detections, dashboards, MITRE ATT&CK mapping, and external log investigations (DNS, DHCP, HTTP, SMTP). | 
